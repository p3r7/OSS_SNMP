...
class Circuit extends AbstractCircuit
{
    ...
    const OID_DESCRIPTION = '21';
    const OID_OPTIONS = '22';
}
...
SNMP OID for Circuit 1.3.6.1.2.1.2.2.4
    ...
    circuitGroup 1.3.6.1.2.1.2.2.4.10.(0-3000)
    partner 1.3.6.1.2.1.2.2.4.11.(0-3000)
    Stack 1.3.6.1.2.1.2.2.4.12.(0-3000)
    CallControl 1.3.6.1.2.1.2.2.4.13.(0-3000)
    DCall 1.3.6.1.2.1.2.2.4.14.(0-3000)
    datalink 1.3.6.1.2.1.2.2.4.15.(0-3000)
    CCStatus 1.3.6.1.2.1.2.2.4.16.(0-3000)
    Initialise 1.3.6.1.2.1.2.2.4.17.(0-3000)
    Block State 1.3.6.1.2.1.2.2.4.18.(0-3000)
    Inservice 1.3.6.1.2.1.2.2.4.19.(0-3000)
    Outservice 1.3.6.1.2.1.2.2.4.20.(0-3000)
    Description 1.3.6.1.2.1.2.2.4.21.(0-3000)
    Options 1.3.6.1.2.1.2.2.4.22.(0-3000)
