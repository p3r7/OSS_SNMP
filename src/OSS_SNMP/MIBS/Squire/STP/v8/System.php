...
class System extends AbstractSystem
{
	...
	const OID_T_SETTLE                          = '28';

	const OID_IN_SERVICE                        = '29';
	const OID_OUT_SERVICE                       = '30';

	const OID_DATE_FORMAT                       = '31';

	const OID_DESCRIPTION                       = '32';

	const OID_PERIODIC                          = '33';

	const OID_OPTIONS                           = '34';

	const OID_TIMER_THREAD_SLEEP_PERIOD         = '35';
...
SNMP OID for System 1.3.6.1.2.1.2.2.14
    ...
    Tsettle 1.3.6.1.2.1.2.2.14.28.(0-1)
    Inservice 1.3.6.1.2.1.2.2.14.29.(0-1)
    Outservice 1.3.6.1.2.1.2.2.14.30.(0-1)
    Date Format 1.3.6.1.2.1.2.2.14.31.(0-1)
    Description 1.3.6.1.2.1.2.2.14.32.(0-1)
    Periodic 1.3.6.1.2.1.2.2.14.33.(0-1)
    Options 1.3.6.1.2.1.2.2.14.34.(0-1)
    Timer Thread Sleep Period 1.3.6.1.2.1.2.2.14.35.(0-1)
