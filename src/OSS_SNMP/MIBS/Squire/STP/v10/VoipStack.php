...
SNMP OID for VoIP Stack 1.3.6.1.2.1.2.2.26
    ...
    NAT Forwarding Address 1.3.6.1.2.1.2.2.26.44.(0-10)
    Options 1.3.6.1.2.1.2.2.26.45.(0-10)
    transport 1.3.6.1.2.1.2.2.26.46.(0-10)
    Max Forwards 1.3.6.1.2.1.2.2.26.47.(0-10)
    ReInvite renegotiate 1.3.6.1.2.1.2.2.26.48.(0-10)
    ISUP Version 1.3.6.1.2.1.2.2.26.49.(0-10)
    ISUP Base Version 1.3.6.1.2.1.2.2.26.50.(0-10)
