...
class SignalingLink extends AbstractSignalingLink
{
	...
	# version-specific
	const OID_TX_BITS_THROTTLE                  = '46';
	const OID_TX_MSU_THROTTLE                   = '47';
	const OID_TX_CONGESTION                     = '48';
	const OID_TX_BINNED                         = '49';
	const OID_M2PA_TIMERS                       = '50';
}
...
SNMP OID for Signalling Link 1.3.6.1.2.1.2.2.3
    ...
    Tx Bits Throttle 1.3.6.1.2.1.2.2.3.46.(0-128)
    Tx MSU Throttle 1.3.6.1.2.1.2.2.3.47.(0-128)
    Tx Congestion 1.3.6.1.2.1.2.2.3.48.(0-128)
    Tx Binned 1.3.6.1.2.1.2.2.3.49.(0-128)
    M2PA Timers 1.3.6.1.2.1.2.2.3.50.(0-128)
